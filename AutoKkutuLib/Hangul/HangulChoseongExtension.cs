...
public static class HangulChoseongExtension
{
	/// <summary>
	...
	public static char Choseong(this char character)
	{
	...
	public static string Choseong(this string str) => string.Concat(str.Select(c => c.Choseong()));
}
