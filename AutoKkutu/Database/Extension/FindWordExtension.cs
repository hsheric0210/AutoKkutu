...
public static class FindWordExtension
{
		...
		PathFinderOptions options)
	{
		...
		var orderPriority = $"({CreateWordPriorityFuncCall(connection, missionChar, preference, endWordFlag, attackWordFlag, param)} + LENGTH({DatabaseConstants.WordColumnName}))";
